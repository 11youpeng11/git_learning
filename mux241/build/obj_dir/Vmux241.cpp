...
void Vmux241::prepareClone() const { contextp()->prepareClone(); }
void Vmux241::atClone() const {
...
VL_ATTR_COLD void Vmux241::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'Vmux241::trace()' called on model that was Verilated without --trace option");
}
