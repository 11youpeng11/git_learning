...
void Vmux241___024root__trace_chg_0_sub_0(Vmux241___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vmux241___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux241___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vmux241___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vmux241___024root__trace_chg_0_sub_0(Vmux241___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux241__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux241___024root__trace_chg_0_sub_0\n"); );
    // Init
